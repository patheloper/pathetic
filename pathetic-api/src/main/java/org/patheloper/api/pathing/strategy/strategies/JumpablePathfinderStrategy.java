...
public class JumpablePathfinderStrategy extends WalkablePathfinderStrategy {
    ...
    public JumpablePathfinderStrategy(int height, int jumpHeight, int maxJumpDistance) {
        ...
        if(maxJumpDistance <= 0) throw new IllegalArgumentException("Jump distance must be greater than 0");
    ...
    @Override
    public boolean isValid(@org.checkerframework.checker.nullness.qual.NonNull PathPosition position, @NonNull SnapshotManager snapshotManager) {
