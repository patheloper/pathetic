...
public class BukkitFailingTerrainProvider implements TerrainProvider {
  ...
  /**
   * The BukkitRequestingTerrainProvider is an inner class of BukkitFailingTerrainProvider, extending it. This
   * class provides additional functionality for ensuring that block data snapshots are available,
   * even if not initially loaded.
   */
  public static class BukkitRequestingTerrainProvider extends BukkitFailingTerrainProvider {
