...
public class PathImpl implements Path {
    ...
    public Path simplify(double epsilon) {
        try {
            ...
            Set<PathPosition> simplifiedPositions = Stream.of(start, end)
    ...
    private void applyMutator(ParameterizedSupplier<PathPosition> mutator, List<PathPosition> positionList) {
