...
public class FilterDependencyValidator {
  ...
  /**
   * Validates the dependencies of the given filter based on the @Depending annotation. This method checks if the
   * filters specified in the @Depending annotation of the current filter pass their validation.
   *
   ...
   *
   * @return true if all the dependencies pass their validation, or if there are no dependencies; false otherwise.
   *
